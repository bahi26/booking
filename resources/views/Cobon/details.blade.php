...
<br/>
<a href="/updateCobon/{{$cobon->id}}"> <i class="fa fa-edit" style="padding-left: 25px"></i>update</a>
<a href="/viewCobon"> <i class="fa fa-edit" style="padding-left: 25px"></i>view all</a><br>
